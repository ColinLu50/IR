...
for i = 1:Num_particles
  ...
  for j = 1:m
    ...
    if (particles(i).landmarks(l).observed == false)
      ...
      IH = inv(H);
      particles(i).landmarks(l).sigma = IH*Q_t*IH';
